...
-- -----------------------------------------------------
-- Schema u953457282_co
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema u953457282_co
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `u953457282_co` DEFAULT CHARACTER SET utf8 ;
USE `u953457282_co` ;

-- -----------------------------------------------------
-- Table `u953457282_co`.`categoria_producto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`categoria_producto` (
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`usuario` (
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`persona`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`persona` (
  ...
  CONSTRAINT `fk_personal_usuario1`
    ...
    REFERENCES `u953457282_co`.`usuario` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`producto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`producto` (
  ...
  CONSTRAINT `fk_producto_categoria`
    ...
    REFERENCES `u953457282_co`.`categoria_producto` (`id_categoria_producto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_producto_persona1`
    FOREIGN KEY (`id_persona`)
    REFERENCES `u953457282_co`.`persona` (`id_persona`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`categoria_negocio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`categoria_negocio` (
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`colonia_negocio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`colonia_negocio` (
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`negocio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`negocio` (
  ...
  CONSTRAINT `fk_negocio_categorias_negocios1`
    ...
    REFERENCES `u953457282_co`.`categoria_negocio` (`id_categoria_negocio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_negocio_direccion1`
    ...
    REFERENCES `u953457282_co`.`colonia_negocio` (`id_colonia_negocio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`categoria_servicio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`categoria_servicio` (
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`colonia_servicio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`colonia_servicio` (
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`servicio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`servicio` (
  ...
  CONSTRAINT `fk_servicios_categoria_servicios1`
    ...
    REFERENCES `u953457282_co`.`categoria_servicio` (`id_categoria_servicio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_servicios_direccion_servicio1`
    ...
    REFERENCES `u953457282_co`.`colonia_servicio` (`id_colonia_servicio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`denuncia_producto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`denuncia_producto` (
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`fecha`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`fecha` (
  `fec_fecha` DATE NOT NULL)
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `u953457282_co`.`administrador`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`administrador` (
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`notificacion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`notificacion` (
  ...
  CONSTRAINT `fk_notificacion_producto1`
    ...
    REFERENCES `u953457282_co`.`producto` (`id_producto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`horario_negocio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`horario_negocio` (
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`horario_servicio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`horario_servicio` (
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`calificacion_negocio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`calificacion_negocio` (
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`calificacion_servicio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`calificacion_servicio` (
  `cal_puntaje` INT(2) NOT NULL,
  `id_usuario` INT(4) NOT NULL,
  `id_servicio` INT(4) NOT NULL,
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`calificacion_usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`calificacion_usuario` (
  `cal_puntaje` INT(2) NOT NULL,
  `id_persona` INT(4) NOT NULL,
  `id_usuario` INT(4) NOT NULL,
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`denuncia_negocio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`denuncia_negocio` (
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`denuncia_servicio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`denuncia_servicio` (
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`publicidad_producto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`publicidad_producto` (
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`publicidad_negocio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`publicidad_negocio` (
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`publicidad_servicio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`publicidad_servicio` (
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`compra`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`compra` (
  `id_compra` INT(4) NOT NULL AUTO_INCREMENT,
  `articulos_total` INT(2) NOT NULL,
...
-- -----------------------------------------------------
-- Table `u953457282_co`.`articulo_compra`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u953457282_co`.`articulo_compra` (
  `id_articulo_compra` INT(4) NOT NULL AUTO_INCREMENT,
  `id_articulo` VARCHAR(30) NOT NULL,
  `id_articulo_repetido` INT(4) NOT NULL,
  `art_nombre` VARCHAR(45) NOT NULL,
  `cantidad_mes` INT(2) NOT NULL,  
  `costo_mes` DECIMAL(7,2) NOT NULL,
  `tipo_articulo` VARCHAR(10) NOT NULL,
  `total` DECIMAL(7,2) NOT NULL,
  `fecha_inicio` DATE NOT NULL,
  `fecha_fin` DATE NOT NULL,
  `id_compra` INT(4) NOT NULL,
  PRIMARY KEY (`id_articulo_compra`))
ENGINE = InnoDB;
