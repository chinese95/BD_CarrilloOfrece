...
-- -----------------------------------------------------
-- Table `carrilloofrece`.`compra`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `carrilloofrece`.`compra` (
...
-- -----------------------------------------------------
-- Table `carrilloofrece`.`articulo_compra`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `carrilloofrece`.`articulo_compra` (
