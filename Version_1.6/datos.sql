...
La instalacion es sencilla y sin tener que efectuar adaptaciones, se colocan de manera directa.',1080,100,'2016-04-22','3','',9,8),
...
Puede realizar su pago por medio de cualquier tarjeta de crédito o debito directamente con nosotros y sin comisión.',1100,250,'2016-04-22','4','',13,9),
...
todo nuevo y 100% metal',575,150,'2016-04-23','5','',3,4);
...
/*--TABLA SERVICIO------------------------------------------------------------------------------*/                        
 ...
 INSERT INTO servicio (ser_nombre,ser_descripcion_breve,ser_descripcion_general,ser_prioridad,ser_fecha_publicacion,ser_imagen,ser_calle,ser_cruzamiento,ser_referencia,ser_red_social,id_categoria_servicio,id_persona,id_colonia_servicio) VALUES ('Mantenimiento de computo','Mantenimiento de computadoras a domicilio.','Se manejan precios accesibles, puede preguntar por cualquier paquete que ustes quiera conusltar, para más información puede hacer una llamada.',150,'2016-04-21','1','De los animales','Entre hormiga y codorniz','Atrás del mercado','',4,5,1),
                           ('Mecanico','Tenemos los mejores precios y servicios automotriz','Tenemos varios tipos de refacciones así como originales, se pueden hacer pedidos. Contamos con serrvicios de balanceo y contamos con nitrigeno.',250,'2016-04-21','2','Golondrina','Entre Javier antonio y Francisco May','A un costado de chedraui','',5,8,2),
                           ('Plomería','Servicio de plomería a domicilio, el mejor servicio..!','Cuento con habilidades para reparar caños rotos, instalación de tuberías normales y complejas.',100,'2016-04-22','3','Liebre','Entre Flabio Y eugenio','A un lado del poder judicial','',17,6,3),
                           ('Taller de Bicicletas','Reparacion de biciletas con precios accesibles','Se reparan bicicletas, se venden refacciones, se engrasan y tambien contamoscon sistema de pedido.',250,'2016-04-22','4','EL gallo','Entre paquita y Del barrio','A un costado del parque de las madres','',5,9,4),
                           ('Electricista','Servicio a domicilio con los mejores precios','Ofresco el servicio a domicilio de electricista, cuento con habilidades para reparación e instalacion de cables electricos en su hogar tomando en cuenta la segurudad.',150,'2016-04-23','5','Hormiga','Entre Lazaro y Pedro','En frente del Conalep','',6,1,5);
