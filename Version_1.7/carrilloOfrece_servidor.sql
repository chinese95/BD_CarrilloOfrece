...
-- -----------------------------------------------------
-- Schema zsoivyrc_carrilloofrece
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema zsoivyrc_carrilloofrece
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `zsoivyrc_carrilloofrece` DEFAULT CHARACTER SET utf8 ;
USE `zsoivyrc_carrilloofrece` ;

-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`categoria_producto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`categoria_producto` (
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`usuario` (
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`persona`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`persona` (
  ...
  CONSTRAINT `fk_personal_usuario1`
    ...
    REFERENCES `zsoivyrc_carrilloofrece`.`usuario` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`producto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`producto` (
  ...
  CONSTRAINT `fk_producto_categoria`
    ...
    REFERENCES `zsoivyrc_carrilloofrece`.`categoria_producto` (`id_categoria_producto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_producto_persona1`
    FOREIGN KEY (`id_persona`)
    REFERENCES `zsoivyrc_carrilloofrece`.`persona` (`id_persona`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`categoria_negocio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`categoria_negocio` (
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`colonia_negocio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`colonia_negocio` (
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`negocio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`negocio` (
  ...
  CONSTRAINT `fk_negocio_categorias_negocios1`
    ...
    REFERENCES `zsoivyrc_carrilloofrece`.`categoria_negocio` (`id_categoria_negocio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_negocio_direccion1`
    ...
    REFERENCES `zsoivyrc_carrilloofrece`.`colonia_negocio` (`id_colonia_negocio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`categoria_servicio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`categoria_servicio` (
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`colonia_servicio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`colonia_servicio` (
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`servicio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`servicio` (
  ...
  CONSTRAINT `fk_servicios_categoria_servicios1`
    ...
    REFERENCES `zsoivyrc_carrilloofrece`.`categoria_servicio` (`id_categoria_servicio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_servicios_direccion_servicio1`
    ...
    REFERENCES `zsoivyrc_carrilloofrece`.`colonia_servicio` (`id_colonia_servicio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`denuncia_producto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`denuncia_producto` (
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`fecha`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`fecha` (
  `fec_fecha` DATE NOT NULL)
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`administrador`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`administrador` (
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`notificacion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`notificacion` (
  ...
  CONSTRAINT `fk_notificacion_producto1`
    ...
    REFERENCES `zsoivyrc_carrilloofrece`.`producto` (`id_producto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`horario_negocio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`horario_negocio` (
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`horario_servicio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`horario_servicio` (
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`calificacion_negocio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`calificacion_negocio` (
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`calificacion_servicio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`calificacion_servicio` (
  `cal_puntaje` INT(2) NOT NULL,
  `id_usuario` INT(4) NOT NULL,
  `id_servicio` INT(4) NOT NULL,
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`calificacion_usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`calificacion_usuario` (
  `cal_puntaje` INT(2) NOT NULL,
  `id_persona` INT(4) NOT NULL,
  `id_usuario` INT(4) NOT NULL,
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`denuncia_negocio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`denuncia_negocio` (
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`denuncia_servicio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`denuncia_servicio` (
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`publicidad_producto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`publicidad_producto` (
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`publicidad_negocio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`publicidad_negocio` (
...
-- -----------------------------------------------------
-- Table `zsoivyrc_carrilloofrece`.`publicidad_servicio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zsoivyrc_carrilloofrece`.`publicidad_servicio` (
